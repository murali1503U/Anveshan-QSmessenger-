        ...
        setContent {
            ...
            MyApplicationTheme(darkTheme = isDarkTheme) {
                Surface(modifier = Modifier.fillMaxSize()) {
                    ...
                    // Intercept back button when inside chat conversation to return to channels list
                    BackHandler(enabled = isInsideChatConversation) {
                        isInsideChatConversation = false
                    }
